...
const imgSrc_hb_zcmc = require('@/assets/lessions/hb_zcmc.png');
const imgSrc_hb_zcjc = require('@/assets/lessions/hb_zcjc.png');
const imgSrc_hb_fqr = require('@/assets/lessions/hb_fqr.png');
const imgSrc_hb_fxzl = require('@/assets/lessions/hb_fxzl.png');
const imgSrc_hb_xsw = require('@/assets/lessions/hb_xsw.png');
const imgSrc_hb_zcms = require('@/assets/lessions/hb_zcms.png');
          ...
          <div className={styles.con_first} >
            <div className={styles.text} >
              ...
              <div className={styles.wdfine}>
                <img src={imgSrc_hb_zcmc} /> <span>资产名称:</span>即数字货币的命名，可以是中文或英文，依公链要求为准，如比特币标准的命名为Bitcoin；
              </div>
              <div className={styles.wdfine}>
                <img src={imgSrc_hb_zcjc} /> <span>资产简称:</span>数字货币简称也是该币种的单位，如比特币的简称是BTC，一个比特币就写作1 BTC；
              </div>
              <div className={styles.wdfine}>
                <img src={imgSrc_hb_fqr} /> <span>发起人:</span>区块链存在匿名性，因此发起人是一个地址，发币后所有资产将全部转入该地址中；
              </div>
              <div className={styles.wdfine}>
                <img src={imgSrc_hb_fxzl} /> <span>发行总量:</span>即该币的总数量。总量的设计与其应用场景密切相关，通常会在白皮书有明确解释；
              </div>
              <div className={styles.wdfine}>
                <img src={imgSrc_hb_xsw} /> <span>小数位:</span>即该币种是几位有效数字。目前主流的设定是8位，依情况而定；
              </div>
              <div className={styles.wdfine}>
                <img src={imgSrc_hb_zcms} /> <span>资产描述:</span>发行资产时可以在这里做简单的描述，这是你在平台上介绍自己的唯一机会，但它不会上链。
              </div>
            </div>
          </div>
